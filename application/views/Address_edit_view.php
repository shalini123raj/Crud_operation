            ...
            <div class="model-header mb-2 " style="width: 450px; border:1px solid black;padding:15px">
                ...
                <div class="model-body p-2">
                    ...
                    <div class="from-group my-3 d-flex flex-column">
                     <div class="from-group my-3 d-flex flex-column">
                        <label  for="Fathername" class="text-black fw-bold">Student FatherName</label>
                        <input type="text" style="color:darkgreen;" name="fathername" placeholder="Enter your fathername" class="from-control" value="<?php echo $singleaddressstudent->Father_name;?>">
                    </div>
                    <div class="from-group d-flex flex-column">
                        <label for="mothername" class="text-black fw-bold">Student MotherName</label>
                        <input type="text" style="color:darkgreen;" name="motherName" placeholder="Enter your mothername" class="from-control" value="<?php echo $singleaddressstudent->Mother_name;?>">
                    </div>
                                   <div class="from-group d-flex flex-column">
                                    <label for="address" class="text-black fw-bold">Student Address</label>
                                    <input type="text" name="address" placeholder="enter your Address " class="from-control" value="<?php echo $singleaddressstudent->Address;?>">
                                   </div>

                                 <div class="from-group d-flex flex-column">
                                 <label for="disti" class="text-black fw-bold">Student Disti</label>
                                 <input type="text" name="Disti" placeholder="enter your Disti" class="from-control" value="<?php echo $singleaddressstudent->Disti;?>">
                                 </div>
