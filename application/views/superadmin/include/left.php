    ...
    <div class="startbar d-print-none">
        ...
        <div class="brand">
            <a href="index-2.html" class="logo">
                <span>
                    <img src="<?php echo base_url()?>media/assets/images/logo-sm.png" alt="logo-small" class="logo-sm">
                </span>
                <span class="">
                    <img src="<?php echo base_url()?>media/assets/images/logo-light.png" alt="logo-large" class="logo-lg logo-light">
                    <img src="<?php echo base_url()?>media/assets/images/logo-dark.png" alt="logo-large" class="logo-lg logo-dark">
                </span>
            </a>
        </div>
        <!--end brand-->
                ...
                <div class="d-flex align-items-start flex-column w-100">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarDashboards">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="index-2.html" class="nav-link ">Analytics</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                    ...
                    <div class="update-msg text-center"> 
                        <div class="d-flex justify-content-center align-items-center thumb-lg update-icon-box  rounded-circle mx-auto">
                            <img src="<?php echo base_url()?>media/assets/images/extra/party.gif" alt="" class="d-inline-block me-1" height="30">
                        </div>                   
